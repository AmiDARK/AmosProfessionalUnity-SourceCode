...
;    called "AMOSPro.Lib", in the APUSystem folder
;
...
; Genam FROM +Music.s TO APro:APUSystem/AMOSProUnity_Music.Lib
; 
...
; AMOSProUnity_Interpretor_Config program (minus one).
...
;        Library_Digest.AMOS
;---------------------------------------------------------------------
        Include    "APUMusic_lib_Size.s"
        Include    "APUMusic_lib_Labels.s"
