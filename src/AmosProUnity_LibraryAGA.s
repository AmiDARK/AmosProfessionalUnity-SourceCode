...
* Va dessiner
    moveq    #0,d4
    move.l    BbTPlan(a4),d4             ; 2019.12.06 casted to .L instead of .W to fix bug in large screens.
    move.l    BbAData(a4),a0
    move.l    BbEc(a4),a3
    lea    EcLogic(a3),a3
    move.w    BbAModD(a4),d0
...
.NoNTSC    rts
    ...
    include "src/AmosProUnityAGA_library/Screens.s"
    ...
    include "src/AmosProUnityAGA_library/CopperListSystem.s"
