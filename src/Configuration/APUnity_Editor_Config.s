...
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	dc.l	.Mn2-.Mn1
.Mn1:
	IncBin	"src/bin/Editor_Menus.asc"
	Even
.Mn2:
...
; **************** 20210218 Update the content of the "About Amos Professional" box - Start
	...
	EdT	189,<    Unity Build Version : Alpha Release3 >  ; * Line 4
; **************** 20210218 Update the content of the "About Amos Professional" box - End
	EdT	190,<>
	EdT	191,<>
	EdT	192,<>
...
.Error1	EdT	0,<>
	...
	EdT	4,<Cannot resume to a label> ;
...
; ~~~~~~~~~~~~~~~~~~~~
	...
	EdT 32,<IFF/ILBM Depth is higher than the screen one>                             ; IFF172
	EdT	33,<Out of data>				
	...
	EdT 42,<IFF/ILBM width is higher than the screen one>                             ; IFF170
	EdT 43,<IFF/ILBM Height is higher than the screen one>                            ; IFF171
...
; ~~~~
	...
	EdT	207,<AGA First screen contains more than 4 bitplanes>                          ; EcE163
	EdT	208,<AGA Second screen contains more than 4 bitplanes>                         ; EcE164
	...
	EdT	211,<ECS Hi-Resolution screen cannot contains more than 4 bitplanes>           ; EcE167
	EdT	212,<ECS Low-Resolution screens cannot contains more than 6 bitplanes>         ; EcE168
	EdT	213,<ECS/AGA non Fetch mode screen required width to be multiple of 16 pixels> ; EcE169
	EdT 214,<IFF/ILBM width is higher than the screen one>                             ; IFF170
	EdT 215,<IFF/ILBM Height is higher than the screen one>                            ; IFF171
	EdT 216,<IFF/ILBM Depth is higher than the screen one>                             ; IFF172
...
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	dc.l	DMenu2-DMenu1
DMenu1	Incbin	"src/bin/Editor_Menus.bin"
	Even
DMenu2	
