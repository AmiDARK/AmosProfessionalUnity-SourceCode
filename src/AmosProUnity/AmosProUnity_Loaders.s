...
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    tst.b    (a0)
    bne.s    .Conf
    lea    NDatas1(pc),a0            AMOSProUnity_Interpretor_Config
    move.l    a0,d1
    jsr    D_OpenD1
    bne.s    .Open
    lea    NDatas3(pc),a0            s/AMOSProUnity_Interpretor_Config
    move.l    a0,d1
    jsr    D_OpenD1
    bne.s    .Open
    lea    NDatas2(pc),a0            s:AMOSProUnity_Interpretor_Config
.Conf    move.l    a0,d1
    jsr    D_OpenD1
    bne.s    .Open
