...
ExtNb        Equ    13-1
    ...
    Include    "AMOSProUnity_Personal_Size.s"
    Include    "AMOSProUnity_Personal_Labels.s"
...
;        Include "Developments:AMOS/amos_includes.s"
...
_NoCopper2
    ...
    Rts
; * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    Lib_Par SCREENOFFSET
    Move.l    (a3)+,d1    ; D1=Y Offset.
...
Dmw    Moveq    #4,d0
    Rbsr    L_CUSTOM
; * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    Lib_Par RESERVESPRITE
    Move.l    (a3)+,d7    ; D7=Length.
...
_Rsend    Moveq    #5,d0
    Rbra    L_CUSTOM
; * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    Lib_Par GETEVENSPRITE
    Move.l    (a3)+,d7    ; D7=LONGUEUR EN LIGNES DU SPRITE !!!
...
_goend    Rts
; * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    Lib_Par ACTIVESPRITE
    Move.l    (a3)+,d3    ; D3=Sprite In Bank.
...
dmz    Moveq    #4,d0
    Rbra    L_CUSTOM
; * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    Lib_Par DOUBLEMASKB2
    Move.l    (a3)+,d4    ; D4=Yend position.
...
; * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    Lib_Par CPALETTE
    Move.l    (a3)+,a0    ; A0=Adresse de calcul
