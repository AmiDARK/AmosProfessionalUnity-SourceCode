...
*******************************************
EcCree:
    ScreenReplacementM ScreenOpen,a0   ; 2020.10.14 Replace EcCree
    movem.l    d1-d7/a1-a6,-(sp)
...
; ************************************************************* 2020.08.13 Update to copy color to both high and low bits of color palette
    ...
    AgaLibCall EcUpdateAGAColorsInCopper ; Yes -> Branch Sub to update aga color palette in copper list.
noCopy2:
...
EcSCol:
    ScreenReplacementM SetColourRGB12,a0
...
getAGAPaletteColour:
    AgaLibNotInitialized ne6
    AgaLibCall getRGB12AgaColor
ne6:
    moveq      #0,d0
    rts
