...
fadeToBlack:
    AgaLibCall agaFade                 ; Uses agaSupport plugin for AGA Fade
    move.l     T_FadeScreen(a5),a0
    AgaLibCall EcSPalAGA_ScreenA0      ; Uses agaSupport plugin to update display AGA color palette
    rts
fadeToPalette:
    AgaLibCall agaFadeToPalette        ; Uses agaSupport plugin for AGA Fade
    move.l     T_FadeScreen(a5),a0
    AgaLibCall EcSPalAGA_ScreenA0      ; Uses agaSupport plugin to update display AGA color palette
    rts
